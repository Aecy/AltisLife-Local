...
civ_spawn_1 = nearestObjects[getMarkerPos  "civ_spawn_1", _altisArray,350];
civ_spawn_2 = nearestObjects[getMarkerPos  "civ_spawn_2", _altisArray,350];
civ_spawn_3 = nearestObjects[getMarkerPos  "civ_spawn_3", _altisArray,350];
civ_spawn_4 = nearestObjects[getMarkerPos  "civ_spawn_4", _altisArray,350];
